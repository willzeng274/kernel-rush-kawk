...
spec=importlib.util.spec_from_file_location('bounded_qkv_driver',HERE/'compile_qkv_n32.py')
...
def check():
    ...
    source=(HERE/'compile_qkv_n32.py').read_text()
    ...
    checks.append(dict(name='one40s_case_88s_internal_cleanup_no_nested_sessions_or_compiler_import',status='PASS'))
