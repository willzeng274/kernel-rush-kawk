...
def verify_source():
    ...
    assert sha((HERE/'snapshots/preparation/SOURCE_SHA256.txt').read_bytes())==m['source_set_sha256']=='9e890ca3af849001ff621713a64a124c9f58db386e7a4abaeae9d62a7cd6fa47'
    extracted=HERE/'down_device.py'
    assert sha(extracted.read_bytes())==m['kernel_sha256']=='da9d50d17b016ce5c2f8b1015c030a5664a8b3461d694dd115affb88d0f98cc5'
    def spans(path):
