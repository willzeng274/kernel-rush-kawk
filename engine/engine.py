"""Retained #32 with four fixed ordinary narrow-MMA projections at B=1..32."""
import torch
from retained_engine import Engine as RetainedEngine
from narrow_layout import NarrowLayout, FAMILIES
...
class Engine(RetainedEngine):
    ...
    def _allocate(self, batch, prompt, output):
        ...
        try:
            ...
            if 1 <= batch <= 32:
                self._narrow_layout = NarrowLayout(self, self._retained_layout, FAMILIES)
